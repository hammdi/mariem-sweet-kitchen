        ...
        "variants": [
          {
            ...
            "portions": 6,
            "ingredients": [
              { "ingredientId": { "name": "Farine", "pricePerUnit": 0.8, "unit": "kg" }, "quantity": 0.2, "unit": "kg" }
            ],
            "appliances": [
...
```json
{
  ...
  "items": [
    { "recipeId": "...", "variantIndex": 0, "quantity": 1 }
  ],
...
{
  "items": [
    { "index": 0, "clientProvidedIngredients": ["ingredient_id_1", "ingredient_id_2"] }
  ],
...
```json
{
  "success": true,
  "data": {
    "ingredientsCost": 4.500,
    "electricityCost": 0.489,
    "waterCost": 0.300,
    "margin": 0.793,
    "total": 6.082,
    "ingredientsDetail": [
      { "name": "Farine", "quantity": 0.2, "unit": "kg", "unitPrice": 0.8, "cost": 0.160, "providedByClient": false }
    ],
    "appliancesDetail": [
      { "name": "Four", "duration": 45, "powerW": 2000, "cost": 0.352 }
    ]
  }
}
```
