...
**Argument portfolio** : *"J'ai intégré 5 features IA en production avec budget plafonné à 20 DT/mois, en combinant providers gratuits et payants selon les cas d'usage. Architecture pensée pour switcher de provider sans refactor."*
