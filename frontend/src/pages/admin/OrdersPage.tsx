...
import {
  ...
  IconButton, Chip, TextField, InputAdornment, Tooltip, Button,
  useMediaQuery,
} from '@mui/material'
                  ...
                  <CardActionArea onClick={() => navigate(`/admin/orders/${order._id}`)}>
                    <CardContent sx={{ py: 1.5, px: 2, '&:last-child': { pb: 1.5 } }}>
                      ...
                      <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', mb: 0.5 }}>
                        <Typography sx={{ fontWeight: 700, fontSize: '1rem' }}>{order.clientName}</Typography>
                        <Chip
                      ...
                      <Box sx={{ display: 'flex', alignItems: 'center', gap: 1, mb: 0.5 }}>
                        <Typography variant="body2" color="text.secondary">{order.clientPhone}</Typography>
                        {showPrep && prep && (
                          prep.preparable ? (
