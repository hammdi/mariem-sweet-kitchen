        ...
        {tab === 0 && (
          <>
            <Typography variant="body2" color="text.secondary" sx={{ mb: 2 }}>
              Notez ce que vous avez a la maison. Quand une commande arrive, vous verrez ce qui
              manque.
            </Typography>
                  ...
                  {filtered.map((ing) => {
                    ...
                    return (
                      <TableRow key={ing._id} sx={{ bgcolor: hasStock ? 'inherit' : '#fff8e1' }}>
                        ...
                        <TableCell>
                          <Chip
                            label={categoryLabels[ing.category] || ing.category}
                            size="small"
                            variant="outlined"
                          />
                        </TableCell>
                        ...
                        <TableCell align="center">
                          {isEditing ? (
                            <TextField
                              ...
                              onKeyDown={(e) => {
                                if (e.key === 'Enter') handleSave(ing._id);
                            ...
                            <Chip
                              ...
                              onClick={() => {
                                ...
                                setEditValue(String(ing.stockQuantity || 0));
                              }}
            ...
            {/* Resume */}
            <Box
              sx={{ mt: 3, display: 'flex', flexDirection: { xs: 'column', sm: 'row' }, gap: 2 }}
            >
              ...
              <TableBody>
                {history.map((h: any) => (
                  <TableRow key={h._id}>
                    <TableCell sx={{ fontSize: '0.85rem' }}>
                      {new Date(h.createdAt).toLocaleDateString('fr-TN', {
                        day: '2-digit',
                        month: '2-digit',
                        year: 'numeric',
                        hour: '2-digit',
                ...
                {history.length === 0 && (
                  <TableRow>
                    ...
                    >
                      Aucun historique. L'historique se remplit quand une commande passe en
                      preparation.
                    </TableCell>
                  </TableRow>
                )}
