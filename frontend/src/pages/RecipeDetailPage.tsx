        ...
        <Grid item xs={12} md={7}>
                            ...
                            <TableCell>
                              <FormControlLabel
                                control={
                                  <Checkbox
                                    ...
                                    onChange={() => {
                                      if (isOffered)
                                        setClientOffered(
                                          clientOffered.filter((id) => id !== ingId)
                                        );
                                ...
                                label={
                                  <Typography
                                    variant="body2"
                                    sx={{ textDecoration: isOffered ? 'line-through' : 'none' }}
                                  >
                                    {name}
                                  </Typography>
                                }
          ...
          <Card sx={{ mb: 2 }}>
            <CardContent>
                  ...
                  <Table size="small">
                    <TableBody>
                      <TableRow>
                        ...
                        <TableCell align="right">
                          {priceInfo.ingredientsCost?.toFixed(3)} DT
                        </TableCell>
                      </TableRow>
                      <TableRow>
                        <TableCell>Electricite (STEG)</TableCell>
                        <TableCell align="right">
                          {priceInfo.electricityCost?.toFixed(3)} DT
                        </TableCell>
                      </TableRow>
                      <TableRow>
                      ...
                      <TableRow sx={{ bgcolor: '#fff3e0' }}>
                        ...
                        <TableCell
                          align="right"
                          sx={{ fontWeight: 700, fontSize: '1.1rem', color: 'primary.main' }}
                        >
              ...
              >
                Si vous ramenez vos propres ingredients, le prix sera reduit. Contactez Mariem pour
                en discuter.
              </Typography>
            </CardContent>
          </Card>
          ...
          {orderForm.requestedDate && (
            ...
            >
              <Typography variant="body2" sx={{ fontWeight: 600 }}>
                Date souhaitee :{' '}
                {new Date(orderForm.requestedDate).toLocaleString('fr-TN', {
                  weekday: 'long',
                  day: '2-digit',
                  month: 'long',
                  hour: '2-digit',
