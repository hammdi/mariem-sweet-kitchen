...
const OrderDatePicker = ({ value, onChange, minLeadHours = 24 }: OrderDatePickerProps) => {
  ...
  const getDateForDay = (day: number) => new Date(calView.getFullYear(), calView.getMonth(), day);
    ...
    <Box sx={{ border: '1px solid #e0e0e0', borderRadius: 2, p: 1.5 }}>
                ...
                bgcolor: sel
                  ...
                  : blocked
                    ...
                    : tod
                      ? '#fff3e0'
                      : 'transparent',
                color: sel ? 'white' : disabled ? '#bbb' : 'text.primary',
      ...
      <Box sx={{ display: 'flex', gap: 1, mt: 1, flexWrap: 'wrap', fontSize: '0.7rem' }}>
        ...
        <Chip
          label="Indispo"
          size="small"
          sx={{ height: 18, fontSize: '0.65rem', bgcolor: '#ffebee' }}
        />
